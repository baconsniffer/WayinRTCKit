// WayinTop Real Time Clock kit
//
// https://github.com/WayinTop
//
// Modified 2021-10-02 by Paul Jenkins
// Changes allow for precise alignment of digits are the are being changed
// and accounting for text size differences between time fields and day/date fields
//
...
void loop() {
  ...
  if(!digitalRead(button1)){                         // If button B1 is pressed
    ...
    date   = edit(60,  0, date,   1);                // Edit date
    month  = edit(78,  0, month,  1);                // Edit month 80
    year   = edit(108, 0, year,   1);                // Edit year 110
    hour   = edit(11, 23, hour,   2);                // Edit hours
    minute = edit(46, 23, minute, 2);                // Edit minutes
